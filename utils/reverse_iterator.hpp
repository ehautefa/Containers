...
namespace ft
{
	...
	public:
		...
		reverse_iterator &operator-=(value_type n)
		{
			_ptr = _ptr + n;
			return (*this);
		}
	...
	reverse_iterator<Iterator> operator+(typename Iterator::difference_type n, const reverse_iterator<Iterator> &rhs) { return (rhs + n); }
